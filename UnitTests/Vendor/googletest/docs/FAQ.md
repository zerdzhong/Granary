...
list can help you decide whether it is for you too.
  ...
  * Simple things are easy in Google TestModel, while hard things are possible: in addition to advanced features like [global test environments](AdvancedGuide.md#global-set-up-and-tear-down) and tests parameterized by [values](AdvancedGuide.md#value-parameterized-tests) or [types](docs/AdvancedGuide.md#typed-tests), Google TestModel supports various ways for the user to extend the framework -- if Google TestModel doesn't do something out of the box, chances are that a user can implement the feature using Google TestModel's public API, without changing Google TestModel itself.  In particular, you can:
    ...
    * teach Google TestModel how to [print your types](AdvancedGuide.md#teaching-google-test-how-to-print-your-values),
    * define your own testing macros or utilities and verify them using Google TestModel's [Service Provider Interface](AdvancedGuide.md#catching-failures), and
...
not enough information in your question):
  ...
  * the version (or the commit hash if you check out from Git directly) of Google TestModel you use (Google TestModel is under active development, so it's possible that your problem has been solved in a later version),
