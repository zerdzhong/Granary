...
regular expression matching, for example), see the [Advanced Google TestModel Guide](V1_6_AdvancedGuide.md).
...
and running Google TestModel tests, read some [samples](V1_6_Samples.md), or continue with
[AdvancedGuide](V1_6_AdvancedGuide.md), which describes many more useful Google TestModel features.
