...
regular expression matching, for example), see the [Advanced Google TestModel Guide](AdvancedGuide.md).
...
[AdvancedGuide](AdvancedGuide.md), which describes many more useful Google TestModel features.
