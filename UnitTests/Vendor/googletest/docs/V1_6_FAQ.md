...
list can help you decide whether it is for you too.
  ...
  * Simple things are easy in Google TestModel, while hard things are possible: in addition to advanced features like [global test environments](V1_6_AdvancedGuide.md#Global_Set-Up_and_Tear-Down) and tests parameterized by [values](V1_6_AdvancedGuide.md#value-parameterized-tests) or [types](V1_6_AdvancedGuide.md#typed-tests), Google TestModel supports various ways for the user to extend the framework -- if Google TestModel doesn't do something out of the box, chances are that a user can implement the feature using Google TestModel's public API, without changing Google TestModel itself.  In particular, you can:
    ...
    * teach Google TestModel how to [print your types](V1_6_AdvancedGuide.md#teaching-google-test-how-to-print-your-values),
    * define your own testing macros or utilities and verify them using Google TestModel's [Service Provider Interface](V1_6_AdvancedGuide.md#catching-failures), and
